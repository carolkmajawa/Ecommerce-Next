...
const products = [
  ...
  },
  {
    ...
    image: "/images/travelingbag.avif",
    price: "$960",
    oldPrice: "$1160",
    rating: 5,
    reviews: 65,
...
export default function ProductCard() {
  return (
    <div className="bg-white px-18 py-1 min-h-screen">
        ...
        {products.map((product, idx) => (
          <div key={idx} className="bg-gray-50 rounded-xl p-4 relative shadow-sm flex flex-col items-center">
            ...
            <div className="mb-4 mt-4 h-32 flex items-center justify-center">
              <Image src={product.image} alt={product.name} width={120} height={120} className="object-contain" priority/>
            </div>
